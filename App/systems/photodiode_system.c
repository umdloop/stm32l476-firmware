 ...
 *
 * Rename:
 *   photodiode_system_init()
 *   photodiode_system_controller()
 *
 * and the filenames:
...
bool photodiode_system_init(void)
{
  /*
...
void photodiode_system_controller(void)
{
  /*
   * Lazy init pattern:
...
In main.c:
  ...
  RR_AddController(photodiode_system_controller);
