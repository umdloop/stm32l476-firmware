...
bool power_pcb_system_init(void)
{
  /*
...
void power_pcb_system_controller(void)
{
  /*
   * Lazy init pattern:
  ...
  if (!s_initialized)
  {
    if (!power_pcb_system_init())
    {
      return;
    }
  }

  ////// Lots of If Statements for CAN I suppose
